...
test('base swipe Slots', async () => {
  ...
  expect(
    container.querySelector('.nut-swipe .nut-swipe-left .nut-button-warp')
  ).toHaveTextContent('选择')

  expect(
    container.querySelector(
      '.nut-swipe .nut-swipe-right .nut-button-danger .nut-button-warp'
    )
...
test('base swipe content', async () => {
  ...
  expect(
    container.querySelector('.nut-swipe .nut-swipe-right .nut-button-warp')
